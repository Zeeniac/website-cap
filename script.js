...
document.querySelector('.kontak-form').addEventListener('submit', function(e) {
    ...
    document.getElementById('newsletterForm').addEventListener('submit', function(e) {
        ...
        // Ganti dengan email perusahaan Anda
        const recipientEmail = 'marketing1@citraproteksi.com';
        const subject = 'Permintaan Informasi - Newsletter';
        const body = `Kepada Yth. Tim Marketing PT. Citra Aqila Proteksi,
        
Dengan hormat,
        
Saya berminat untuk mendapatkan informasi lebih lanjut tentang produk dan layanan PT. Citra Aqila Proteksi.
        
Berikut adalah alamat email saya untuk didaftarkan dalam newsletter:
Email: ${email}
        
Saya berharap dapat menerima update informasi terbaru dari perusahaan.
...
Subscriber Potential`;
        ...
        subscribers.push({ email: email, date: new Date().toLocaleString('id-ID') });
